package asunit.framework {
    ...
    public class AllTests extends TestSuite {
        ...
        public function AllTests() {
            ...
            addTest(new asunit.framework.TestCaseAsyncSetUpTearDown());
            addTest(new asunit.framework.TestCaseSetUpTearDown());
            addTest(new asunit.framework.TestCasePreReqCleanUpTest());
        }
    }
}
