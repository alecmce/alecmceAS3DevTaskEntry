package asunit.framework
{
    ...
    public class AsyncMethodTest extends TestCase {
        ...
        protected override function setUp():void {
            instance = new Sprite();
            listener = addAsync(onInstanceAddedToStage);
            instance.addEventListener(Event.ADDED, listener);
            addChild(instance);
        }

        private function onInstanceAddedToStage(event:Event):void
        {
            instance.removeEventListener(Event.ADDED, listener);
        ...
        public function asyncSetupHandler():void{
            ...
            listener = addAsync(onAsyncInstanceAddedToStage);
            asyncInstance.addEventListener(Event.ADDED, listener);
            addChild(asyncInstance);
        }
        private function onAsyncInstanceAddedToStage(event:Event):void
        {
            asyncInstance.removeEventListener(Event.ADDED, listener);
        }
